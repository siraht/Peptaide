      ...
      <nav className="w-64 flex-none bg-surface-light dark:bg-surface-dark border-r border-border-light dark:border-border-dark flex flex-col justify-between py-4">
        <div className="space-y-1 px-3">
          ...
          <Link
            ...
            href={tabHref('substances', selectedSubstanceId ? { substance_id: selectedSubstanceId } : undefined)}
          >
            <span className="material-icons-outlined text-xl">biotech</span>
            Substances
          </Link>

          <Link
            className="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors group"
            href="/routes"
          >
            <span className="material-icons-outlined text-xl group-hover:text-primary transition-colors">alt_route</span>
            Routes
          </Link>
          <Link
            className="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors group"
            href="/formulations"
          >
            <span className="material-icons-outlined text-xl group-hover:text-primary transition-colors">medication</span>
            Formulations
          </Link>
          <Link
            className="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors group"
            href="/devices"
          >
            <span className="material-icons-outlined text-xl group-hover:text-primary transition-colors">vaccines</span>
            Devices
          </Link>
          ...
          <Link
            ...
            href="/inventory"
          >
            <span className="material-icons-outlined text-xl group-hover:text-primary transition-colors">inventory_2</span>
            Inventory
          </Link>
          <Link
            className="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors group"
            href="/orders"
          >
            <span className="material-icons-outlined text-xl group-hover:text-primary transition-colors">shopping_cart</span>
            Orders
          </Link>
          <Link
            className="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors group"
            href="/cycles"
          >
            <span className="material-icons-outlined text-xl group-hover:text-primary transition-colors">timeline</span>
            Cycles
          </Link>
          ...
          <Link
            ...
            href="/distributions"
          >
            <span className="material-icons-outlined text-xl group-hover:text-primary transition-colors">functions</span>
            Distributions
          </Link>
          <Link
            className="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors group"
          ...
          >
            <span className="material-icons-outlined text-xl group-hover:text-primary transition-colors">link</span>
            Evidence
          </Link>
          <Link
            className={`flex items-center gap-3 px-3 py-2 rounded-lg transition-colors ${
