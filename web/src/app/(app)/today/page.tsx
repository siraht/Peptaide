  ...
  return (
    <div className="h-full flex flex-col xl:flex-row overflow-hidden" data-e2e="today-root">
      ...
      >
        ...
        <div className="h-56 sm:h-64 border-t border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-[#151a23] flex flex-col shrink-0">
      ...
      >
        <div className="shrink-0 flex items-center justify-between px-4 pb-3 pt-5 sm:px-6">
          <div>
