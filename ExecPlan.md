...
- [ ] UI: expand the command palette to cover keyboard-first "actions" (not just navigation), including "create substance", "create formulation", and a "log event" quick flow. (Completed: basic header nav links; added a Ctrl/Cmd+K command palette for navigation.) plan[414-421]
