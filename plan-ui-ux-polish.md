...
- [ ] (2026-02-11 00:40Z) Commit the current uncommitted UI polish changes (ellipsis fixes, `color-scheme`, `theme-color`, mobile hub sidebar collapse, and the `/analytics` restyle) so they are not lost and so future diffs stay reviewable.
